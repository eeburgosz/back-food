...
const { DB_PASSWORD, DB_USER, DB_HOST, DATABASE_URL, DATABASE_USER, DATABASE_PASSWORD } = process.env;
...
const sequelize = process.env.NODE_ENV === 'production'
   ...
   //       }
   //    })
   new Sequelize(`postgres://${DATABASE_USER}:${DATABASE_PASSWORD}@${DATABASE_URL}/food`, { logging: false })
   :
